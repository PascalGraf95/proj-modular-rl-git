...
def main():
    ...
    environment_path = None #r"C:\PGraf\Arbeit\RL\EnvironmentBuilds\3DAirHockeyGameUntilGoalRandomHumanBackWallStop\AirHockeyRebuild.exe" # In case of "OpenAIGym" enter the desired env name here, e.g. "LunarLanderContinuous-v2"
